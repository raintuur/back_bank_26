...
INSERT INTO public.location (id, city_id, name, status) VALUES (DEFAULT, 1, 'Järve Selver', 'A');
INSERT INTO public.location (id, city_id, name, status) VALUES (DEFAULT, 1, 'Tondi Selver', 'A');
INSERT INTO public.location (id, city_id, name, status) VALUES (DEFAULT, 3, 'Port Arturi Selver', 'A');
INSERT INTO public.location (id, city_id, name, status) VALUES (DEFAULT, 2, 'Veeriku Selver', 'A');


INSERT INTO public.atm (id, serial_number, location_id, status) VALUES (DEFAULT, 'AAA', 1, 'A');
INSERT INTO public.atm (id, serial_number, location_id, status) VALUES (DEFAULT, 'BBB', 1, 'A');
INSERT INTO public.atm (id, serial_number, location_id, status) VALUES (DEFAULT, 'CCC', 3, 'A');
INSERT INTO public.atm (id, serial_number, location_id, status) VALUES (DEFAULT, 'DDD', 4, 'A');
